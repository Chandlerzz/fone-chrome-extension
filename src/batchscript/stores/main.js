  ...
  actions: {
    getDataFromLocalStorage() {
      ...
      if (origin.startsWith('http://localhost')) {
        ...
        f_lastSelectedApplication = JSON.parse(localStorage.getItem('f_lastSelectedApplication'))
        f_sessionId = JSON.parse(localStorage.getItem('f_sessionId'))
        f_authorization = JSON.parse(localStorage.getItem('f_authorization'))

        this.headers['Ewaresoft-FOne-SessionId'] = f_sessionId ? f_sessionId.data : ''
        this.headers['Ewaresoft-FOne-GlobalUserId'] = f_userInfo.user_id
        this.headers['Ewaresoft-FOne-ApplicationId'] = f_lastSelectedApplication._id
        this.headers['Ewaresoft-FOne-ApplicationUserId'] = f_lastSelectedApplication.organization_id
        ...
        chrome.storage.sync.get(storageKeys, (result) => {
          ...
          if (f_lastSelectedApplication) {
            f_lastSelectedApplication = JSON.parse(f_lastSelectedApplication)
            this.headers['Ewaresoft-FOne-ApplicationId'] = f_lastSelectedApplication._id
