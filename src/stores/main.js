  ...
  actions: {
    getDataFromLocalStorage() {
      ...
      const env = {
        ...
        foneProd: "https://fone.risen.com",
        foneDevelop: "http://10.10.9.27",
        extension: "",
      };
      if (
        origin.startsWith(env.develop) || origin.startsWith(env.foneDevelop)
      ) {
        this.baseUrl = "http://10.10.9.27/";
      } else if (origin.startsWith(env.foneProd)) {
      ...
      if (
        origin.startsWith(env.develop) ||
        origin.startsWith(env.foneProd) || origin.startsWith(env.foneDevelop)
      ) {
